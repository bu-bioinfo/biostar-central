...
class Post(models.Model):
    ...
    def json_data(self):
        data = {
            ...
            'author_uid': '@anon' if self.anon else self.author.profile.uid,
            'lastedit_user_uid': '@anon' if self.anon else self.lastedit_user.profile.uid,
            'author': '@anon' if self.anon else self.author.profile.name,
